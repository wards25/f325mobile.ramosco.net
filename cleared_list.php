...
$f325number = $_SESSION['f325number'];
    ...
    ?>
        ...
        <?php 
            if($row['db_id']=='0'){
                echo '<td><center><input type="number" style="width:45px;" class="form-control form-control-sm quantity" data-id="'.$row['id'].'" value="'.$row['quantity'].'"></center></td>';
            }else{
                echo '<td><center>'.$row['quantity'].'</center></td>';
            }
        ?>
        <td><center><input type="number" style="width:45px;" class="form-control form-control-sm received-qty" data-id="<?php echo $row['id']?>" value="<?php echo $row['received'];?>" required></center></td>
        <td><center><input type="number" style="width:70px;" class="form-control form-control-sm unitcost" data-id="<?php echo $row['id']?>" value="<?php echo $row['unitcost'];?>" step="any" required></center></td>

        <?php
            if($row['db_id']=='0'){
                echo '<td><center><input type="text" style="width:45px;" class="form-control form-control-sm reason" data-id="'.$row['id'].'" value="'.$row['reason'].'" required></td></center>';
            }else{
            ...
            if($row['db_id']=='0'){
                echo '<td><center><input type="date" class="form-control form-control-sm bbd" data-id="'.$row['id'].'" value="'.$row['bbd'].'" required></center></td>';
            }else{
