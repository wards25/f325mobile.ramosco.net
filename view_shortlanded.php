            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <input type="text" class="form-control form-control-sm" value="<?php echo $fetch_sl['slno']; ?>"
                            readonly>
                    </div>
                </div>
                <hr>
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="input-group">
                            ...
                            &nbsp;&nbsp;&nbsp;
                            <span class="input-group-addon"><a type="submit" name="view" class="data btn-sm btn-warning"
                                    style="background-color: #915c83;"
                                    onclick="window.open('view_f325.php?f325number=<?php echo $f325number; ?>')">View</a></span>
                        </div>
                    </div>
                </div>
                <hr>
                    ...
                    <div class="col-12">
                        ...
                        <div class="input-group">
                            ...
                            <span class="input-group-addon"><a type="button"
                                    class="d-sm-inline-block btn btn-sm btn-info shadow-sm" href="#" data-toggle="modal"
                                    data-target="#documentModal">Document</a></span>
                        </div>
                    </div>
                </div>
                <hr>
                <div class="row">
                    <div class="col-6">
                        ...
                        if ($fetch_sl['checkdate'] == '0000-00-00') {
                            ...
                            ?>
                            <input type="text" class="form-control form-control-sm"
                                value="<?php echo $fetch_sl['checkdate']; ?>" readonly>
                            <?php
                        }
                        ?>
                    </div>
                ...
                <center>
                    ...
                    if ($fetch_sl['paymentstatus'] == 'UNPAID') {
                        ?>
                        <a type="button" class="d-sm-inline-block btn btn-sm btn-success shadow-sm" href="#" data-toggle="modal"
                            data-target="#slModal"><i class="fa fa-xs fa-money-bill"></i> Fulfill Payment</a>
                        <?php
                    } else {
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            $image_path = 'img/no-image.png'; // Default fallback
                        
                            foreach ($extensions as $ext) {
                                $test_path = "uploads/shortlanded/" . $f325number . "." . $ext;
