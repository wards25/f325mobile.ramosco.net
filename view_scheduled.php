    ...
    if (!isset($_POST['view'])) {
                ...
                <div class="row">
                    <div class="col-12">
                        <form id="ScanForm">
                            ...
                            <input type="text" class="form-control form-control-sm" name="mdccode" autofocus="on"
                                autocomplete="off" placeholder="click to scan barcode...">
                            <input type="text" name="name" value="<?php echo $_SESSION['fname']; ?>" hidden>
                            <td>
                                <center><button type="submit" id="scan" name="add" class="btn btn-sm"
                                        style="background:#915c83; color:#ffffff;" hidden><i class="fa fa-boxes"></i> Add
                                        Item(s)</button></center>
                            </td>
                        </form>
                    </div>
                </div>
                ...
                <form method="POST" action="cleared_process.php" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <a href="" type="button" class="close" aria-label="Close" data-toggle="modal"
                                data-target="#infoModal">
                                <span aria-hidden="true"><i class="fa fa-info-circle fa-xs"
                                        style="color:#915c83;"></i></span>
                            </a>
                    ...
                    <div class="row">
                        <div class="col-6">
                            ...
                            <input type="file" accept="image/*" capture="capture"
                                class="form-control form-control-sm document" id="document" name="image" disabled />
                        </div>
                        <div class="col-6">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-12">
                                <a type="button" class="btn btn-info btn-user btn-block btn-sm shadow" href="#"
                                    data-toggle="modal" data-target="#historyModal">View History</a>
                            </div>
                        </div>
                    </div>
                    <hr>
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            ...
                                            <input type="number" class="form-control form-control-sm" name="f325number"
                                                value="<?php echo $f325number; ?>" maxlength="12" readonly>
                                        </div>
                                        <div class="col-6">
                                            <label><i>F325 Date:</i></label>
                                            <input type="date" class="form-control form-control-sm" name="f325date"
                                                value="<?php echo $fetch_info['f325date']; ?>" readonly>
                                        </div>
                                    </div>
                                    <hr>
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            <input type="text" class="form-control form-control-sm"
                                                value="<?php echo $fetch_branch['code'] . " - " . $fetch_branch['branchname']; ?>"
                                                readonly>
                                            <input type="text" name="code" value="<?php echo $code; ?>" id="branchcode"
                                                hidden>
                                        </div>
                                    </div>
                                    <hr>
                                    <div class="row">
                                        <div class="col-6">
                                            ...
                                            <input type="date" class="form-control form-control-sm" name="emaildate"
                                                value="<?php echo $fetch_info['emaildate']; ?>" readonly>
                                        </div>
                                        <div class="col-6">
                                            <label><i>Verification Date:</i></label>
                                            <input type="date" class="form-control form-control-sm" name="emaildate"
                                                value="<?php echo $fetch_info['verificationdate']; ?>" readonly>
                                        </div>
                                    </div>
                                    <hr>
                                    <div class="row">
                                        <div class="col-6">
                                            ...
                                            <input type="text" class="form-control form-control-sm" name="prepared"
                                                value="<?php echo $fetch_info['preparedby']; ?>" readonly>
                                        </div>
                                        <div class="col-6">
                                            <label><i>Issued By:</i></label>
                                            <input type="text" class="form-control form-control-sm" name="issued"
                                                value="<?php echo $fetch_info['issuedby']; ?>" readonly>
                                        </div>
                                    </div>
                                    <hr>
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            <input type="text" class="form-control form-control-sm" name="driver"
                                                value="<?php echo $fetch_info['drivername']; ?>" readonly>
                                        </div>
                                    </div>
                                    <hr>
                                    <div class="row">
                                        <div class="col-6">
                                            ...
                                            <input type="number" class="form-control form-control-sm" name="tmnumber"
                                                value="<?php echo $fetch_info['tmnumber']; ?>" readonly>
                                        </div>
                                        <div class="col-6">
                                            <label><i>Plate No:</i></label>
                                            <input type="text" class="form-control form-control-sm" name="platenumber"
                                                value="<?php echo $fetch_info['platenumber']; ?>" readonly>
                                        </div>
                                    </div>
                                    <hr>
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            ?>
                                            <input type="text" class="form-control form-control-sm"
                                                value="<?php echo $fetch_branch['name']; ?>" readonly>
                                            <input type="text" class="form-control form-control-sm vendorcode"
                                                value="<?php echo $company; ?>" hidden>
                                            <input type="text" name="vendorcode" value="<?php echo $fetch_info['vendor']; ?>"
                                                hidden>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <tr>
                                <td>
                                    <center><a type="button" class="btn btn-sm" href="#" data-toggle="modal"
                                            data-target="#itemModal" style="background:#915c83; color:#ffffff;"><i
                                                class="fa fa-boxes"></i> Add Item(s)</a></center>
                                </td>
                            </tr>
                        </div>
                    </div>
                    ...
                    <center>
                        ...
                        <button type="submit" name="submit" class="btn bt-sm btn-success btn-sm"><i class="fa fa-stamp"></i>
                            Clear F325</button>
                </form>
                </center>
            </div>
        ...
        <div class="modal fade" id="verificationModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h6 class="modal-title" id="exampleModalLabel" style="color:#915c83;">Select Verification Reason
                        </h6>
                        <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">×</span>
                        </button>
                    ...
                    <form method="POST" action="verification_process.php">
                        ...
                        <div class="modal-footer">
                            ...
                            <button class="btn btn-warning text-dark btn-sm" name="submit" type="submit"><i
                                    class="fa fa-sm fa-check"></i> For Verification</button>
                        </div>
                    </form>
                </div>
            </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form id="ItemForm">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <select class="form-control form-control-sm search-product" name="mdccode"
                                            id="category-list" required>
                                        </select>
                                        </select>
                                    </div>
                                </div>
                                        ...
                                        if ($result->num_rows > 0) {
                                            ...
                                            <select class="form-control form-control-sm" name="reason" required>
                                                ...
                                                foreach ($options as $option) {
                                                    ?>
                                                    <option value="<?php echo $option['nameinitial']; ?>">
                                                        <?php echo $option['nameinitial'] . ' - ' . $option['reason']; ?> </option>
                                                <?php
                                                }
                                        }
                                        ?>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <input type="number" class="form-control form-control-sm" name="unit" step="any"
                                            required>
                                    </div>
                                </div>
                            </div><!-- 
                        ...
                        <div class="modal-footer">
                            <button class="btn btn-secondary btn-sm" type="button" data-dismiss="modal">Cancel</button>
                            <button type="submit" id="add" name="add" class="btn btn-sm"
                                style="background:#915c83; color:#ffffff;"><i class="fa fa-boxes"></i> Add Item(s)</button>
                        </div>
                    </form>
                </div>
            </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form id="DeleteItem">
                        ...
                        <div class="modal-footer">
                            <button class="btn btn-secondary btn-sm" type="button" data-dismiss="modal">Cancel</button>
                            <button class="btn btn-danger btn-sm" type="submit"><i class="fa fa-sm fa-trash"></i>
                                Delete</button>
                        </div>
                    </form>
                </div>
