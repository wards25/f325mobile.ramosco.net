...
if(!isset($_SESSION['id']) || $_SESSION['print']=='0')
{
...
?>
                ...
                <h1 class="h3 mb-0 text-gray-800">BORF F325</h1>
                </div>
                ...
                <?php } ?>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Total Sales App BORF F325</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php
                                                    $scheduled_query = mysqli_query($conn,"SELECT * FROM dbborflist WHERE emaildate BETWEEN '2023-01-01' AND NOW()");
                    ...
                    <form method="POST" action="borf.php">
                        <div class="form-row">
                            <div class="col-9">
                                <?php 
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered" id="dataTable" width="100%" cellspacing="0">
                                            ...
                                            <tbody class="text-center">
                                                ...
                                                $result = mysqli_query($conn,"SELECT * FROM dbborflist WHERE emaildate BETWEEN '2023-01-01' AND NOW()");
                                                while($row = mysqli_fetch_array($result))
                                                    {
                                                ?>
                                                    <?php echo '<td>'.$row['emaildate'].'</td>'; ?>
                                                    <?php echo '<td>'.$row['borfnumber'].'</td>'; ?>
                                                    <?php echo '<td>'.$row['f325number'].'</td>'; ?>
                                                    <td><center><a type="submit" name="view" class="data btn-sm btn-success" onclick="window.open('view_borf.php?f325number=<?php echo $row['f325number'] ?>')">View</a></center></td>
                                                </tr>
                                            <?php
                                                }
                                            ?>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-striped table-bordered" id="dataTable" width="100%" cellspacing="0">
                                                ...
                                                <tbody class="text-center">
                                                    ...
                                                    $result = mysqli_query($conn,"SELECT * FROM dbborflist WHERE vendor = '$vendor' AND emaildate BETWEEN '2023-01-01' AND NOW()");
                                                    while($row = mysqli_fetch_array($result))
                                                        {
                                                    ?>
                                                        <?php echo '<td>'.$row['emaildate'].'</td>'; ?>
