...
?>
                ...
                <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-body">
                            <?php
                            $info_query = mysqli_query($conn,"SELECT * FROM dbborflist WHERE f325number = '$f325number'");
                            $fetch_info = mysqli_fetch_array($info_query);
                            ?>
                                    <div class="row">
                                        <div class="col-6">
                                            <label><i>BORF No:</i></label>
                                            <input type="number" class="form-control form-control-sm" value="<?php echo $fetch_info['borfnumber']; ?>" readonly>
                                        </div>
                                        <div class="col-6">
                                            <label><i>Processed By:</i></label>
                                            <input type="text" class="form-control form-control-sm" value="<?php echo $fetch_info['userprocessed']; ?>" readonly>
                                        </div>
                                    </div>
                                    <hr>
                                    <div class="row">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-12">
                                                    <label>Remarks:</label>
                                                    <textarea class="form-control form-control-sm" rows="3" value="<?php echo $fetch_product['remarks']; ?>" readonly></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <hr>
