...
?>
                ...
                <h1 class="h3 mb-0 text-gray-800">Verification F325</h1>
                </div>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col ml-4 mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Total For Verification F325</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php
                                                    $scheduled_query = mysqli_query($conn,"SELECT * FROM dbf325number WHERE status = 'scheduled' AND verificationdate IS NOT NULL AND emaildate BETWEEN '2023-01-01' AND NOW()");
                                                    if(!$scheduled_query){
                                            ...
                                            <small class="mb-0 text-gray-800">as of <?php echo date("h:i A"); ?> | <a href="scheduled.php">View Scheduled</a></small>
                                        </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered" id="dataTable" width="100%" cellspacing="0">
                                            ...
                                            <tbody class="text-center">
                                                ...
                                                $result = mysqli_query($conn,"SELECT * FROM dbf325number WHERE status = 'scheduled' AND verificationdate != '0000-00-00' AND emaildate BETWEEN '2023-01-01' AND NOW()");
                                                while($row = mysqli_fetch_array($result))
                                                    {
                                                        $datetime1 = new DateTime($row['verificationdate']);
                                                        $difference = $datetime1->diff($datetime2);
                                                        $diff = $difference->format('%a' );
                                                ?>
                                                    <?php echo '<td>'.$row['verificationdate'].'</td>'; ?>
                                                    <?php echo '<td>'.$row['f325number'].'</td>'; ?>
                                                    <?php echo '<td class="text-danger">'.$diff.' Days</td>'; ?>
                                                    <?php echo '<td>'.$row['verificationreason'].'</td>'; ?>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered" id="dataTable" width="100%" cellspacing="0">
                                            ...
                                            <tbody class="text-center">
                                                ...
                                                $result = mysqli_query($conn,"SELECT * FROM dbf325number WHERE status = 'scheduled' AND verificationdate != '0000-00-00' AND vendor = '$vendor' AND emaildate BETWEEN '2023-01-01' AND NOW()");
                                                while($row = mysqli_fetch_array($result))
                                                    {
                                                        $datetime1 = new DateTime($row['verificationdate']);
                                                        $difference = $datetime1->diff($datetime2);
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody class="text-center">
                                        ...
                                        $result = mysqli_query($conn,"SELECT * FROM dbf325number WHERE status = 'scheduled' AND verificationdate IS NOT NULL AND emaildate BETWEEN '2023-01-01' AND NOW()");
                                        while($row = mysqli_fetch_array($result))
                                            {
                                                $datetime1 = new DateTime($row['verificationdate']);
                                                $difference = $datetime1->diff($datetime2);
