...
<div class="container-fluid">
                        ...
                        <div class="col mr-2">
                            ...
                            <div>
                                <div class="input-group mb-3">
                                    <input type="file" class="form-control" placeholder="for_pullout"
                                        aria-label="for pull out">
                                    <button class="btn btn-primary btn-sm fas fa-calendar">Upload</button>
                            </div>
                        </div>
    ...
    <form method="POST" action="for_pullout.php">
        <div class="form-row">
            <div class="col-9">
                <?php
