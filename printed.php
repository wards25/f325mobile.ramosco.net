...
?>
                ...
                <h1 class="h3 mb-0 text-gray-800">Printed F325</h1>
                </div>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php
                                                    $printed_query = mysqli_query($conn,"SELECT * FROM dbf325number WHERE status = 'printed' OR status ='open' AND emaildate BETWEEN '2024-01-01' AND NOW()");
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody class="text-center">
                                        ...
                                        $result = mysqli_query($conn,"SELECT * FROM dbf325number WHERE status = 'printed' OR status ='open' AND emaildate BETWEEN '2023-01-01' AND NOW()");
