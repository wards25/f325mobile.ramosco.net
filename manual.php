            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-6">
                        ...
                        <input type="number" id="f325number" class="form-control form-control-sm" name="f325number"
                            onKeyPress="if(this.value.length==12) return false;" onInput="checkUsername()" required>
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            <select class="form-control form-control-sm" onChange="getcategory(this.value);" name="company"
                                id="company" required>
...
>>>>>>> 44ac350420260f5310e58126a5ef01461f12204f
                ...
                <center>
                    <hr>
                    <button type="submit" name="submit" class="btn btn-success btn-sm"><i class="fa fa-plus"></i> Add
                        F325</button>
        </form>
        </center>
    </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-12">
                                <label>Reason:</label>
                                <select class="form-control form-control-sm" name="reason" id="reason-list" required>
                                </select>
                            </div>
                        </div>
                    </div>
