            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-6">
                        ...
                        <input type="number" class="form-control form-control-sm" value="<?php echo $f325number; ?>"
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <input type="text" class="form-control form-control-sm"
                            value="<?php echo $fetch_branch['code'] . " - " . $fetch_branch['branchname']; ?>" readonly>
                    </div>
                </div>
                <hr>
                <div class="row">
                    ...
                    <div class="col-6">
                        ...
                        <input type="text" class="form-control form-control-sm" value="<?php echo $fetch_info['status']; ?>"
                            readonly>
                    </div>
                </div>
                <hr>
                            ...
                            <table class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    while ($fetch_product = mysqli_fetch_array($product_query)) {
                                        ...
                                        ?>
                                        <tr>
                                            <?php echo '<td><center>' . $fetch_product['mdccode'] . ' -- ' . $fetch_description['description'] . '</center></td>'; ?>
                                            <?php echo '<td><center>' . $fetch_product['expiration'] . '</center></td>'; ?>
                ...
                <center>
                    ...
                    if ($sl_count == 1) {
                        ?>
                        <a type="button" class="d-sm-inline-block btn btn-sm btn-danger shadow-sm" href="#" data-toggle="modal"
                            data-target="#slModal"><i class="fa fa-xs fa-money-bill"></i> SL Info</a>
                        <?php
                    } else {
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h6 class="modal-title" id="exampleModalLabel" style="color:#915c83;">Shortlanded Info</h6>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            <input type="text" class="form-control form-control-sm"
                                                value="<?php echo $fetch_sl['slno']; ?>" readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-6">
                                            <label><i>Driver Name:</i></label>
                                            <input type="text" class="form-control form-control-sm"
                                                value="<?php echo $fetch_sl['drivername']; ?>" readonly>
                                        </div>
                                        <div class="col-6">
                                            <label><i>SL Date:</i></label>
                                            <input type="text" class="form-control form-control-sm"
                                                value="<?php echo $fetch_sl['dateprocessed']; ?>" readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control form-control-sm"
                                                    value="<?php echo $fetch_sl['checkedby']; ?>" readonly>
                                                &nbsp;&nbsp;&nbsp;
                                                <span class="input-group-addon"><a type="button"
                                                        class="d-sm-inline-block btn btn-sm btn-info shadow-sm" href="#"
                                                        data-toggle="modal" data-target="#documentModal">Document</a></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <input type="text" class="form-control form-control-sm"
                                                value="<?php echo $fetch_sl['paymentstatus']; ?>" readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            <textarea class="form-control form-control-sm" rows="3"
                                                value="<?php echo $fetch_product['remarks']; ?>" readonly></textarea>
                                        </div>
                                    </div>
                                </div>
                                <hr>
                                    ...
                                    <table class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            while ($fetch_unpaid = mysqli_fetch_array($unpaid_query)) {
                                                ?>
                                                <tr>
                                                    <?php echo '<td><center>' . $fetch_unpaid['mdccode'] . '</center></td>'; ?>
                                                    <?php echo '<td><center>' . $fetch_unpaid['qty'] . '</center></td>'; ?>
                                                    <?php echo '<td><center>' . $fetch_unpaid['costextended'] . '</center></td>'; ?>
                                                    <?php
                                            }
                                            ?>
                                                <?php
                                                ...
                                                echo '<tr class="table-warning"><td colspan="2" class="table-light text-dark"><b>Total SL Amount Vat-in: </b></td>';
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <a class="btn btn-success btn-sm" type="button"
                                    onclick="window.open('download_f325.php?f325number=<?php echo $f325number; ?>&folder=dbapps')"><i
                                        class="fa fa-sm fa-download"></i> Download</a>
